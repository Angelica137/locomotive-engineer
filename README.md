...
This is the Lcomotive Engineer on Exercism's Python Ttrack.

This exercise is to practice packing and unpacking. 

## Instructions

There are several ways to solve the exercise, you need to solve it using packing, unpacking and multiple assignments.
